...
class FruitProductNotifier with ChangeNotifier{
  ...
  FruitProductNotifier(FruitLoadingTabsCount loading){
      _categories=[
        FruitProductCategory(fruitCategory: FruitVariety.Berries,categoryName: "Berries",loadingTabsCount: loading),
        FruitProductCategory(fruitCategory: FruitVariety.Citrus,categoryName:"Citrus",loadingTabsCount: loading),
        FruitProductCategory(fruitCategory: FruitVariety.Melons,categoryName: "Melons",loadingTabsCount: loading),
        FruitProductCategory(fruitCategory: FruitVariety.Miscelaneous,categoryName:"Tomatoes and Avocados",loadingTabsCount: loading),
        FruitProductCategory(fruitCategory: FruitVariety.Stone_Fruit,categoryName:"Stone Fruit",loadingTabsCount: loading),
        FruitProductCategory(fruitCategory: FruitVariety.Tropical,categoryName: "Tropical",loadingTabsCount: loading),
        FruitProductCategory(fruitCategory: FruitVariety.Apples,categoryName: "Apples",loadingTabsCount: loading),
      ];
  }

  UnmodifiableListView<FruitProductCategory> get category=>UnmodifiableListView(_categories);
  UnmodifiableListView<FruitProduct> get allFruits=>UnmodifiableListView(
  _categories.expand((element) => element.products).toSet().toList(growable: false)
  );
  UnmodifiableListView<FruitProduct> get recommendedProduct=>UnmodifiableListView(_recommendedFruits);
...
Stream<List<FruitProduct>> _flashProducts=Stream<List<FruitProduct>>.periodic(Duration(seconds: 2),getProductLikeHttpS);
...
class FruitProductCategory with ChangeNotifier{
  ...
  FruitProductCategory({this.categoryName, this.fruitCategory,this.loadingTabsCount});
  bool _isloading=false;
  bool get isLoading=>_isloading;
  final FruitLoadingTabsCount loadingTabsCount;
  UnmodifiableListView<FruitProduct> get products=>UnmodifiableListView(_fruitProducts);
  void intialiseProducts(){
    var productsForCategory=fruitProducts.where((product) => product.variety==fruitCategory).toList();
  ...
  Future<void> refresh() async{
      ...
      var product=await Future<FruitProduct>.delayed((Duration(milliseconds: 100)),getProductLikeHttp);
      ...
      if(product.variety==fruitCategory){
        ...
        if(!_fruitProducts.contains(product))
        _fruitProducts.add(product);
      }
      // _isloading=false;
      notifyListeners();
      // loadingTabsCount.value-=1;
...
class FruitData extends Equatable{
  ...
  FruitData({this.categoryName, this.imagePath,this.variety});
