...
class ProductNotifier with ChangeNotifier{
  ...
  ProductNotifier(LoadingTabsCount loading){
      _categories=[
        ProductCategory(productCategory: Variety.Leafy_Green,loadingTabsCount: loading),
        ProductCategory(productCategory: Variety.Cruciferous,loadingTabsCount: loading),
        ProductCategory(productCategory: Variety.Marrow,loadingTabsCount: loading),
        ProductCategory(productCategory: Variety.Allium,loadingTabsCount: loading),
  ...
  UnmodifiableListView<ProductCategory> get category=>UnmodifiableListView(_categories);
  UnmodifiableListView<Product> get allProducts=>UnmodifiableListView(
  _categories.expand((element) => element.products).toSet().toList(growable: false)
  );
  UnmodifiableListView<Product> get recommendedProduct=>UnmodifiableListView(_recommendedProducts);
...
Stream<List<Product>> _flashProducts=Stream<List<Product>>.periodic(Duration(seconds: 2),getProductLikeHttpS).asBroadcastStream();
...
class ProductCategory with ChangeNotifier{
  ...
  ProductCategory({this.productCategory,this.loadingTabsCount});
  ...
  Future<void> refresh() async{
      ...
      var product=await Future<Product>.delayed((Duration(seconds: 1)),getProductLikeHttp);
