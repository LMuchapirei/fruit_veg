...
class WishListNotifier extends ChangeNotifier {
  ...
  UnmodifiableListView<Product> get productsWishList =>
      UnmodifiableListView<Product>(_products);
  UnmodifiableListView<FruitProduct> get fruitProductsWishList =>
      UnmodifiableListView<FruitProduct>(_fruitProducts);
  ...
  int get itemsCount =>
      _unitProductFruits.length +
      _unitProductVegetables.length +
      _products.length +
      _fruitProducts.length;
}
