...
final reviews = <UserReview>[
  UserReview(
      ...
      reviewText:
          'There are a few foods that predate colonization and the European colonization of\n the Americans brought about the introduction of a large number of \ningredients'),
  UserReview(
      imagePath: 'null for now',
      brandName: "Google",
      brandId: 12,
