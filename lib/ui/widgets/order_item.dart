...
import 'package:fruit_veg/ui/views/orderdetails.dart';
          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Image(
                  fit: BoxFit.fill,
                  image: AssetImage(order.product[0].imagePath),
                ),
              ),
            ),
...
class OrderItemGrid extends StatelessWidget {
  ...
  const OrderItemGrid({Key? key, required this.order}) : super(key: key);
  @override
  Widget build(BuildContext context) {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "\$" + order.product[0].price.toString(),
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            order.product[0].sales.toString() + " Sales",
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                order.product[0].rating.toString(),
                                style: headerTextStyle.copyWith(fontSize: 14),
                              )
                            ],
                          )
