              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                      ...
                      child:
                          Icon(Icons.remove_circle_outline, color: iconColor))
                ],
              ),
            )
          ],
...
class CartItemFruit extends StatefulWidget {
  ...
  const CartItemFruit({Key? key, required this.product}) : super(key: key);
...
class _CartItemFruitState extends State<CartItemFruit> {
  int countItem = 0;
  Future<double?> _changeProductWeight(
                ...
                children: <Widget>[
                  InkWell(
                      onTap: () async {
                        ...
                        double? newWeight =
                            await _changeProductWeight(context, currentWeight);
                        Provider.of<CartNotifier>(context)
                            .changeProductWeight(widget.product, newWeight!);
                      },
                      child: Icon(
                        Icons.edit,
                        color: iconColor,
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('Selected Weight ', style: headerTextStyle),
                Text(
                  val.toStringAsPrecision(4) + " kg",
