...
import 'package:fruit_veg/ui/viewutils/utilities.dart';
        ...
        headerSliverBuilder: (context, scroll) {
          return <Widget>[
            SliverAppBar(
              ...
              pinned: true,
              title: Text(widget.order.product[0].name),
              floating: false,
              expandedHeight: 250,
                ...
                children: [
                  Expanded(
                    ...
                    children: [
                      Image(
                        fit: BoxFit.cover,
                        image: AssetImage(widget.order.product[0].imagePath),
                      ),
                      Container(
        ...
        body: Padding(
          ...
          child: Column(
              ...
              children: [
                ...
                Text(
                  widget.order.product[0].description,
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          dateFormatter(widget.order.dateCreated),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          dateFormatter(widget.order.datePaid),
                          style: headerTextStyle.copyWith(fontSize: 15),
                        ),
                      ],
                    )
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          widget.order.itemsCost.toString(),
                          style: headerTextStyle.copyWith(fontSize: 15),
                        ),
                      ],
                    )
