...
import 'package:fruit_veg/ui/widgets/scrollview_item.dart';
...
class UnitItemsHome extends StatefulWidget {
  ...
  const UnitItemsHome({Key? key, required this.unitProductType})
      : super(key: key);
  @override
    ...
    return Column(
      children: fruits
          .map((fruit) => UnitItem(
                ...
                unitProductVegetable: UnitProductVegetable(
                    barCode: '',
                    description: '',
                    discount: null,
                    imagePath: '',
        ...
        children: [
          ...
          Flexible(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(color: headerTextColor),
                child: Row(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          'VIEW CART(${cartProvider.itemsCount})',
                          style: headerTextStyle.copyWith(
