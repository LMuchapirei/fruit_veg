...
class VegetableDetails extends StatelessWidget {
  ...
  const VegetableDetails(
      {Key? key, required this.product, required this.variety})
      : super(key: key);
  ...
  String generateFacts() {
    ...
    switch (variety) {
      ...
      case Variety.Allium:
        fact =
            "There is nary a cuisine that doesn’t include allium vegetables. Onions, garlic, leeks, shallots, and scallions are all members of the Allium genus and are fundamental to so many dishes that cooking.Garlic (Allium sativum) is used as a flavoring ingredient in food preparations and promoted as a DS for patients with hypertension and hyperlipidemia, and for preventing cardiovascular disease. Garlic is used to prevent various cancers, including colorectal, gastric, breast, and prostate cancers.";
        break;
      case Variety.Marrow:
        fact =
            "Marrow – pumpkin, cucumber and zucchini provides variety of benefits.";
        break;
      case Variety.Root:
        fact =
      ...
      case Variety.Stem:
        fact =
            "Unlike other veggies in your crisper, stem vegetables have the unique advantage of being almost entirely edible. (No de-seeding, skinning, or peeling necessary!) “Stem vegetables are very well known for being entirely edible and not having to get rid of anything,These include celery and asparagus";
        break;
    }
    return fact;
  }
